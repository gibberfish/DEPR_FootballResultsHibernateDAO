...
public class Tester {
	...
	for (Season season : (List<Season>) seasons) {
		...
		System.out.println("..DIVISION: " + seasonDivision.getDivision().getDivisionName() + ", pos: " + seasonDivision.getDivisionPosition());
	...
	seasonDivision.setDivisionPosition(pos);
